...
The goal is simple: learn deeply by implementing, experimenting, failing, and improving.
No copy-paste tutorials. No shallow demos. Every project here is built to strengthen core understanding.
...
Project-Name/
│
├── dataset/             # Data used (or source link)
├── notebook.ipynb       # Experiment notebook
├── model.py             # Core implementation (if applicable)
...
If you're learning ML too or want to collaborate, feel free to connect.
